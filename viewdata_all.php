   ...
   div.dataTables_wrapper div.dataTables_filter input[type="search"] {
            ...
            <div class="col-12">
                <div class="data_table">
                    <table id="example" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
                            $select_query = mysqli_query(
                                $connection,
                                "SELECT
    r.*,
    sc.Name_Arabic AS scientific_council_name,
    ec.center_name AS center_name,
    r.scientific_council_id As scientific_council_id_type,
    c.country_name,
    ...
    "
                            ...
                            while ($data = mysqli_fetch_array($select_query)) {
                                if ($data['scientific_council_id_type'] == $_SESSION['admin_type'] || $_SESSION['admin_type'] == 'all') {
                                    echo "<tr>";
                                    echo "<td>" . $data['id'] . "</td>";
